...
subtitle: "Ciblage des manques de complétude essentiels et consultation des données pour le département du Morbihan (56)"
...
### Manque de complétude sur ouvrages prioritaires (`r nrow(nb_manque_op %>% filter(dept_code %in% c('56'))) %>% format(scientific=FALSE, big.mark=" ")` ouvrages)
...
afficher_carte(readPNG('data/cartes/MORBIHAN_manque_completude_OP.PNG'))
```


### Manque de complétude sur ouvrages en Liste 2 (L214.17) (`r nrow(nb_manque_l2 %>% filter(dept_code %in% c('56'))) %>% format(scientific=FALSE, big.mark=" ")` ouvrages)
...
afficher_carte(readPNG('data/cartes/MORBIHAN_manque_completude_L2.PNG'))
```


### Ouvrages non validés (`r nrow(nb_non_valides %>% filter(dept_code %in% c('56'))) %>% format(scientific=FALSE, big.mark=" ")` ouvrages)
...
afficher_carte(readPNG('data/cartes/MORBIHAN_manque_completude_NON_VALIDE.PNG'))
```


### Ouvrages sans 'Etat' (`r nrow(nb_manque_etat %>% filter(dept_code %in% c('56'))) %>% format(scientific=FALSE, big.mark=" ")` ouvrages)
...
afficher_carte(readPNG('data/cartes/MORBIHAN_manque_completude_ETAT.PNG'))
```


### Ouvrages sans 'Type' (`r nrow(nb_manque_type %>% filter(dept_code %in% c('56'))) %>% format(scientific=FALSE, big.mark=" ")` ouvrages)
...
afficher_carte(readPNG('data/cartes/MORBIHAN_manque_completude_TYPE.PNG'))
```


### Ouvrages sans 'Hauteur de chute' (`r nrow(nb_manque_hc %>% filter(dept_code %in% c('56'))) %>% format(scientific=FALSE, big.mark=" ")` ouvrages)
...
afficher_carte(readPNG('data/cartes/MORBIHAN_manque_completude_HC.PNG'))
```


### Ouvrages sans 'Dispositif de franchissement piscicole' (`r nrow(nb_manque_fip %>% filter(dept_code %in% c('56'))) %>% format(scientific=FALSE, big.mark=" ")` ouvrages)
...
afficher_carte(readPNG('data/cartes/MORBIHAN_manque_completude_FIP.PNG'))
```


### Ouvrages situés en Liste2 (L214.17) sans 'ATG' (`r nrow(nb_manque_atg_l2 %>% filter(dept_code %in% c('56'))) %>% format(scientific=FALSE, big.mark=" ")` ouvrages)
...
afficher_carte(readPNG('data/cartes/MORBIHAN_manque_atg_L2.PNG'))
```


### Ouvrages en manque de cohérence entre l'état, la hauteur de chute et l'ATG (`r nrow(nb_mec_atg_hc %>% filter(dept_code %in% c('56'))) %>% format(scientific=FALSE, big.mark=" ")` ouvrages)
...
afficher_carte(readPNG('data/cartes/MORBIHAN_manque_coherence_etat_hc_atg.PNG'))
```
...
afficher_carte(readPNG('data/cartes/MORBIHAN_manque_me.PNG'))
```
