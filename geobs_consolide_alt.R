...
ggplot(data = bdroe_dr2_maj, 
       aes(x = fct_rev(fct_infreq(etat_nom)))) +
  geom_bar(fill = "blue") +
  coord_flip() +
...
ggplot(data = bdroe_dr2_maj, 
       aes(x = fct_rev(fct_infreq(type_nom)))) +
  geom_bar(fill = "blue") +
  coord_flip() +
...
ggplot(data = bdroe_dr2_maj, 
       aes(x = fct_rev(fct_infreq(fpi_nom1)))) +
  geom_bar(fill = "blue") +
  coord_flip() +
...
ggplot(data = bdroe_dr2_maj, 
       aes(x = fct_rev(fct_infreq(avis_technique_global)))) +
  geom_bar(fill = "blue") +
  coord_flip() +
  labs(x = "ATG",
       y = "Nombre d'ouvrages",
...
## Usages
ggplot(data = bdroe_dr2_maj, 
       aes(x = fct_rev(fct_infreq(usage_nom1)))) +
  geom_bar(fill = "blue") +
  coord_flip() +
  labs(x = "Type d'usage",
       y = "Nombre d'ouvrages",
...
ggplot(data = bdroe_dr2_maj, 
       aes(x = lubridate::ymd_hms(date_modification))) +
