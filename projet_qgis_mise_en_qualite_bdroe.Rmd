...
Il est recommandé, pour une utilisation optimale de ce projet (affichage des étiquettes notamment), de **le consulter avec une version supérieure ou égale à 3.34. de Qgis**.

# Le groupe de données "Mise en qualité ROE-BDOE" : pour cibler les ouvrages présentant des lacunes attributaires essentielles

## La couche BDROE

### Représentation graphique de la couche BDROE

L'analyse proposée repose sur la couche **BDROE_interne_BZH_PDL_20250727**.
...
* dont l’état est entièrement détruit (ou dérasé dans la BDOE) **ET** :
  
    * dont la hauteur de chute est nulle  
    * **OU** dont l’Avis Technique Global est positif (ou éventuellement indéterminé). Ils sont alors considérés comme "soldés" et ne sont donc pas priorisés).
...
**Besoin mise en cohérence dérasement - HC – ATG** : ouvrages  indiqués comme dérasés ou entièrement détruits, mais dont la hauteur de chute est non nulle et dont l'Avis technique Global (ATG) n'est pas positif (ou indéterminé). 

**ATG non renseigné en L2** : ouvrage situé en Liste 2 ne disposant pas de l’information "Avis technique Global", dans la BDOE.

**Ouvrage secondaire liés** : indique les ouvrages secondaires qui sont liés à un ouvrage principal.
...
L'analyse proposée repose sur la couche **BDROE_interne_BZH_PDL_20250727** précedemment évoquée, sans écarter les ouvrages gelés ou dérasés.
...
* Les **Zones d’Action Prioritaire Anguille** (ZAP)
