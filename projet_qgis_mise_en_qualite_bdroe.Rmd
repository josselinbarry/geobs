...
* dont l’état est entièrement détruit (ou dérasé dans la BDOE) **ET** dont la hauteur de chute est nulle **ET** dont l’Avis Technique Global est positif (ils sont alors considérés comme "soldés" et ne sont donc pas priorisés).
